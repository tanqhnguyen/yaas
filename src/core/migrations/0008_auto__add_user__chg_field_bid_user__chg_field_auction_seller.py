...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Bid.user'
        db.alter_column(u'core_bid', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.User']))

        # Changing field 'Auction.seller'
        db.alter_column(u'core_auction', 'seller_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.User']))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Bid.user'
        db.alter_column(u'core_bid', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

        # Changing field 'Auction.seller'
        db.alter_column(u'core_auction', 'seller_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
    ...
    models = {
        ...
        u'core.auction': {
            ...
            'seller': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'auctions'", 'to': u"orm['core.User']"}),
        ...
        u'core.bid': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'bids'", 'to': u"orm['core.User']"})
        },
        u'core.user': {
