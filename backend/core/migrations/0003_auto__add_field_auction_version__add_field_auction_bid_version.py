...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Auction.version'
        db.add_column(u'core_auction', 'version',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Auction.bid_version'
        db.add_column(u'core_auction', 'bid_version',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Auction.version'
        db.delete_column(u'core_auction', 'version')

        # Deleting field 'Auction.bid_version'
        db.delete_column(u'core_auction', 'bid_version')
